<?php
$config = $config =  get_post_meta( $post->ID, 'config', true );

if( !is_array( $config ) ){
    $config = get_option( 'wpt_configure_options' );
}

function wpt_selected_data(  $config, $keyword, $gotten_value ){
    $config = isset( $config ) && is_array( $config ) && count( $config ) > 0 ? $config : get_option( 'wpt_configure_options' );
    
    
    echo ( isset( $config[$keyword] ) && $config[$keyword] == $gotten_value ? 'selected' : false  );
}

$wpt_default_config = false;
/**********************/
if( isset( $_GET['default'] ) ){
    $wpt_default_config = true;
    $config = get_option( 'wpt_configure_options' );
}
//*********************/
?>
...
<div style="padding-top: 15px;padding-bottom: 15px;" class="fieldwrap wpt_result_footer">
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[custom_add_to_cart]" id="wpt_table_custom_add_to_cart" class="wpt_fullwidth" >
                                <option value="add_cart_no_icon" <?php wpt_selected_data(  $config, 'custom_add_to_cart',  'add_cart_no_icon' );?>><?php esc_html_e( 'No Icon', 'wpt_pro' );?></option>
                                <option value="add_cart_only_icon" <?php wpt_selected_data(  $config, 'custom_add_to_cart',  'add_cart_only_icon' );?>><?php esc_html_e( 'Only Icon', 'wpt_pro' );?></option>
                                <option value="add_cart_left_icon" <?php wpt_selected_data(  $config, 'custom_add_to_cart',  'add_cart_left_icon' );?>><?php esc_html_e( 'Left Icon and Text', 'wpt_pro' );?></option>
                                <option value="add_cart_right_icon" <?php wpt_selected_data(  $config, 'custom_add_to_cart',  'add_cart_right_icon' );?>><?php esc_html_e( 'Text and Right Icon', 'wpt_pro' );?></option>
                            </select>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[footer_cart]" id="wpt_table_footer_cart" class="wpt_fullwidth" >
                                <option value="hide_for_zerro" <?php wpt_selected_data(  $config, 'footer_cart',  'hide_for_zerro' );?>><?php esc_html_e( 'Hide for Zero', 'wpt_pro' );?></option>
                                <option value="always_show" <?php wpt_selected_data(  $config, 'footer_cart',  'always_show' );?>><?php esc_html_e( 'Always Show', 'wpt_pro' );?></option>
                                <option value="always_hide" <?php wpt_selected_data(  $config, 'footer_cart',  'always_hide' );?>><?php esc_html_e( 'Always Hide', 'wpt_pro' );?></option>
                            </select>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[footer_possition]" id="wpt_table_footer_possition" class="wpt_fullwidth" >
                                <option value="bottom_right" <?php wpt_selected_data(  $config, 'footer_possition',  'bottom_right' );?>><?php esc_html_e( 'Bottom Right', 'wpt_pro' );?></option>
                                <option value="bottom_left" <?php wpt_selected_data(  $config, 'footer_possition',  'bottom_left' );?>><?php esc_html_e( 'Bottom Left', 'wpt_pro' );?></option>
                                <option value="top_right" <?php wpt_selected_data(  $config, 'footer_possition',  'top_right' );?>><?php esc_html_e( 'Top Right', 'wpt_pro' );?></option>
                                <option value="top_left" <?php wpt_selected_data(  $config, 'footer_possition',  'top_left' );?>><?php esc_html_e( 'Top Left', 'wpt_pro' );?></option>
                            </select>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[sort_mini_filter]" id="wpt_table_sort_mini_filter" class="wpt_fullwidth" >
                                <option value="0" <?php wpt_selected_data(  $config, 'sort_mini_filter',  '0' );?>><?php esc_html_e( 'None', 'wpt_pro' );?></option>
                                <option value="ASC" <?php wpt_selected_data(  $config, 'sort_mini_filter',  'ASC' );?>><?php esc_html_e( 'Ascending', 'wpt_pro' );?></option>
                                <option value="DESC" <?php wpt_selected_data(  $config, 'sort_mini_filter',  'DESC' );?>><?php esc_html_e( 'Descending', 'wpt_pro' );?></option>
                            </select>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[sort_searchbox_filter]" id="wpt_table_sort_mini_filter" class="wpt_fullwidth" >
                                <option value="0" <?php wpt_selected_data(  $config, 'sort_searchbox_filter',  '0' );?>><?php esc_html_e( 'None', 'wpt_pro' );?></option>
                                <option value="ASC" <?php wpt_selected_data(  $config, 'sort_searchbox_filter',  'ASC' );?>><?php esc_html_e( 'Ascending', 'wpt_pro' );?></option>
                                <option value="DESC" <?php wpt_selected_data(  $config, 'sort_searchbox_filter',  'DESC' );?>><?php esc_html_e( 'Descending', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                           <select name="config[popup_notice]" id="wpt_table_popup_notice" class="wpt_fullwidth" >
                                <option value="1" <?php wpt_selected_data(  $config, 'popup_notice',  '1' );?>><?php esc_html_e( 'Enable', 'wpt_pro' );?></option>
                                <option value="0" <?php wpt_selected_data(  $config, 'popup_notice',  '0' );?>><?php esc_html_e( 'Disable', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                           ...
                           <select name="config[thumbs_lightbox]" id="wpt_table_thumbs_lightbox" class="wpt_fullwidth" >
                                <option value="1" <?php wpt_selected_data(  $config, 'thumbs_lightbox',  '1' );?>><?php esc_html_e( 'Enable', 'wpt_pro' );?></option>
                                <option value="0" <?php wpt_selected_data(  $config, 'thumbs_lightbox',  '0' );?>><?php esc_html_e( 'Disable', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[disable_product_link]" id="wpt_table_disable_product_link" class="wpt_fullwidth" >
                                <option value="1" <?php wpt_selected_data(  $config, 'disable_product_link',  '1' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                                <option value="0" <?php wpt_selected_data(  $config, 'disable_product_link',  '0' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[product_link_target]" id="wpt_table_disable_product_link" class="wpt_fullwidth" >
                                <option value="_blank" <?php wpt_selected_data(  $config, 'product_link_target',  '_blank' );?>><?php esc_html_e( 'New Tab', 'wpt_pro' );?></option>
                                <option value="_self" <?php wpt_selected_data(  $config, 'product_link_target',  '_self' );?>><?php esc_html_e( 'Self Tab', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[all_selected_direct_checkout]" id="wpt_table_all_selected_direct_checkout" class="wpt_fullwidth" >
                                <option value="no" <?php wpt_selected_data(  $config, 'all_selected_direct_checkout',  'no' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                                <option value="yes" <?php wpt_selected_data(  $config, 'all_selected_direct_checkout',  'yes' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[product_direct_checkout]" id="wpt_table_product_direct_checkout" class="wpt_fullwidth" >
                                <option value="no" <?php wpt_selected_data(  $config, 'product_direct_checkout',  'no' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                                <option value="yes" <?php wpt_selected_data(  $config, 'product_direct_checkout',  'yes' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                            </select>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[disable_cat_tag_link]" id="wpt_table_disable_product_link" class="wpt_fullwidth" >
                                <option value="1" <?php wpt_selected_data(  $config, 'disable_cat_tag_link',  '1' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                                <option value="0" <?php wpt_selected_data(  $config, 'disable_cat_tag_link',  '0' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                            <select name="config[disable_loading_more]" id="wpt_table_disable_loading_more" class="wpt_fullwidth" >
                                <option value="load_more_hidden" <?php wpt_selected_data(  $config, 'disable_loading_more',  'load_more_hidden' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                                <option value="normal" <?php wpt_selected_data(  $config, 'disable_loading_more',  'normal' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
                    ...
                    <div class="wpt_column">
                        ...
                        <td>
                           <select name="config[instant_search_filter]" id="wpt_table_instant_search_filter" class="wpt_fullwidth" >
                                <option value="1" <?php wpt_selected_data(  $config, 'instant_search_filter',  '1' );?>><?php esc_html_e( 'Yes', 'wpt_pro' );?></option>
                                <option value="0" <?php wpt_selected_data(  $config, 'instant_search_filter',  '0' );?>><?php esc_html_e( 'No', 'wpt_pro' );?></option>
                            </select>
                        </td>
                     </div>
                </tr>
        ...
        <?php if( !$wpt_default_config ){?>
            ...
            $wpt_reset_url = $wpt_current_url . '&default=yes#config';
            ?>
            <p><?php esc_html_e( 'Remember: \'Get from Config\' will not store other tab\'s change. So First Update, If you changed others tab. such: Column,Basics etc, Then change Here.', 'wpt_pro' ); ?></p>
            <a class="button wpt_style_reset_button" href="<?php echo $wpt_reset_url; ?>"><?php esc_html_e( 'Get from Config', 'wpt_pro' ); ?></a>
        <?php }else{ ?>
        <p><?php esc_html_e( 'Now you can save/update.', 'wpt_pro' ); ?></p>    
        <?php } ?>
        </div>
</div>
